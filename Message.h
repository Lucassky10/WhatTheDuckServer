...
/* Enum strings */
static const string enumMessageTypes[] = { "Demande de la configuration", "Configuration", "Canard trouvé", "Le client %i a trouvé %i canard(s)", "Tous les canards ont été trouvés", "x: %i, y: %i, z: %i" };
